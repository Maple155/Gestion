...
public class InventaireController {
    ...
    public String listeInventaires(
        ...
        String userRole = session.getAttribute("userRole") != null ? 
            session.getAttribute("userRole").toString() : "UTILISATEUR";
        
        // Pagination avec tri
        Sort.Direction direction = "asc".equalsIgnoreCase(ordre) ? 
    ...
    public String formulaireNouvelInventaire(
        ...
        if (depotId != null) model.addAttribute("depotId", depotId);
        if (zoneId != null) model.addAttribute("zoneId", zoneId);
        if (categorieId != null) model.addAttribute("categorieId", categorieId);
    ...
    public String detailsInventaire(
            ...
            @RequestParam(required = false) String statutLigne,
    ...
    public String interfaceComptage(
        ...
        Map<String, Object> progression = inventaireService.getProgressionComptage(UUID.fromString(inventaireId), userId);
    ...
    public Map<String, Object> enregistrerComptage(
        ...
        try {
            ...
            if (!estRecomptage && ligne.getEcart() != null) {
                BigDecimal valeurEcart = ligne.getEcartValeur() != null ? 
                    ligne.getEcartValeur().abs() : BigDecimal.ZERO;
            ...
            if (Boolean.parseBoolean(data.get("autoNext", "false"))) {
                LigneInventaire prochaineLigne = inventaireService.getProchaineLigneACompter(
    ...
    public String cloturerInventaire(
        ...
        try {
            ...
            redirectAttributes.addFlashAttribute("success", 
                ...
                " - Précision: " + inventaire.getTauxPrecision() + "%");
    ...
    public String rapportInventaire(
        ...
        try {
            ...
            if ("HTML".equals(format)) {
                ...
                // model.addAttribute("stats", stats);
                // model.addAttribute("title", "Rapport Inventaire " + inventaire.getReference());
