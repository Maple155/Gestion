...
public class MouvementController {
    ...
    public String journalMouvements(Model model,
        ...
        Page<Map<String, Object>> pageMouvements = mouvementService.rechercherMouvements(
            UUID.fromString(typeMouvement), UUID.fromString(articleId), UUID.fromString(depotId), dateDebut, dateFin, pageable);
    ...
    public String formulaireSortie(Model model,
        ...
        if (articleId != null) {
            ...
            if (depotId != null) {
                List<Map<String, Object>> lots = lotService.getLotsDisponiblesArticle(UUID.fromString(articleId), UUID.fromString(depotId));
    ...
    public String creerEntree(@RequestParam Map<String, String> params,
        ...
        try {
            ...
            Map<String, Object> resultat = mouvementService.creerMouvementEntree(params, UUID.fromString(utilisateurId));
    ...
    public String creerSortie(@RequestParam Map<String, String> params,
        ...
        try {
            String utilisateurId = (String) session.getAttribute("userId");
            Map<String, Object> resultat = mouvementService.creerMouvementSortie(params, UUID.fromString(utilisateurId));
    ...
    public String annulerMouvement(@PathVariable String id,
        ...
        try {
            String utilisateurId = (String) session.getAttribute("userId");
            mouvementService.annulerMouvement(UUID.fromString(id), motif, UUID.fromString(utilisateurId));
